export type Blog = {
  ...
  id: number;
  image_cover?: string | DirectusFiles | null;
  slug: string;
  sort?: number | null;
  status: string;
  tags?: unknown | null;
...
export type PageSections = {
  collection?: string | null;
  id: number;
  item: string | PageSectionsItem[];
  pages_id?: number | Pages | null;
};

export type PageSectionsItem = {
  collection?: string | null;
  id: number;
  item?: string | any | null;
  page_sections_id?: number | PageSections | null;
};
...
export type Slider = {
  id: number;
  slider: string | SliderFiles[];
};

export type SliderFiles = {
  directus_files_id?: string | DirectusFiles | null;
  id: number;
  slider_id?: number | Slider | null;
};

export type TextBodies = {
  id: number;
  text?: string | null;
};
...
export type CustomDirectusTypes = {
  blog: Blog;
  blog_translations: BlogTranslations;
  ...
  page_sections_item: PageSectionsItem;
  pages: Pages;
  pages_sections: PagesSections;
  slider: Slider;
  slider_files: SliderFiles;
  text_bodies: TextBodies;
};
